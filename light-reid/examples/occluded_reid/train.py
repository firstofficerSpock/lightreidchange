...
parser.add_argument('--config_file', type=str, default='/home/vipuser/Desktop/light-reid/examples/occluded_reid/configs/config_occludedreid_resnet50.yaml', help='')
